...
################################################################
#                                                              #
#       PROJECT:    Berkeley Files PHP Class                   #
...
/**
 * A PHP class to easily interact with berkeley data 
 * files using an iterator interface. It implements insertion,
 * update, deletion, search, regex search, truncation and
 * optimization of berkeley database files.
 *
 * @author     Arturo Lopez
 * @copyright  Copyright (c) 2008, Arturo Lopez
 * @version    0.1
 */
 
class Berkeley implements Iterator
{
    /**
    * Path to data file
    */
